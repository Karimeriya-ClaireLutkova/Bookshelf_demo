...
export const authorProject = "Светлана Луткова.";
...
"Но и людям сейчас крайне необходимо развиваться и не забывать про чтение. Именно оно делает нас умнее. " +
"И взрослые, и дети - все умеют пользоваться телефоном, много времени не выпускают его из рук. Почему бы тогда не почитать электронную книжку?";
