...
function Books({ booksAll, onMovieDelete, onChangeDescription, buttonInactive, currentUser }) {
  ...
  return (
    <section className="elements" aria-label="Список книг">
      ...
      <div className="elements__container">
        {booksList.map((book, i) => (<BookCard key={book.id} book={book} onMovieDelete={onMovieDelete} currentUser={currentUser} />))}
      </div>
